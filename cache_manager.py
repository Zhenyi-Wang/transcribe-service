...
class CacheManager:
    ...
    def get_cached_transcript(self, url: str = None, bvid: str = None, audio_id: str = None, file_path: str = None, context: str = None, diarize: bool = False) -> Optional[Dict[str, Any]]:
        """获取缓存的转录结果"""
        if not self.cache_enabled:
            return None
    ...
    def save_transcript_to_cache(self, url: str = None, transcript_data: Dict[str, Any] = None, bvid: str = None, audio_id: str = None, file_path: str = None, context: str = None, diarize: bool = False) -> None:
        """保存转录结果到缓存"""
